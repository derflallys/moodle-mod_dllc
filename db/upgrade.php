...
/**
 * This file keeps track of upgrades to the dllc module
 *
...
/**
 * Execute dllc upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_dllc_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the dllc
     * iself has been upgraded.
     *
     * For each upgrade block, the file dllc/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to dllc.
        ...
        // Define field intro to be added to dllc.
        $table = new xmldb_table('dllc');
        ...
        // Define field introformat to be added to dllc.
        $table = new xmldb_table('dllc');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'dllc');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to dllc.
        $table = new xmldb_table('dllc');
        ...
        // Define field timemodified to be added to dllc.
        $table = new xmldb_table('dllc');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'dllc');
    }
